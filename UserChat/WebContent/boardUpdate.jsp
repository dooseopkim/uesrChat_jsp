			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd;">
				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" type="text" name="boardTitle" placeholder="글 제목을 입력하세요" value="<%= board.getBoardTitle()%>"></td>
					</tr>	
					<tr>
						<td style="width:110px;"><h5>글 내용</h5></td>
						<td><textArea class="form-control" rows="10" name="boardContent" maxlength="2048" placeholder="글 내용을 입력하세요"><%= board.getBoardTitle() %></textArea></td>
					</tr>										
					<tr>
